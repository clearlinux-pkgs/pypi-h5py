...
Source0  : https://files.pythonhosted.org/packages/03/2e/a22d6a8bfa6f8be33e7febd985680fba531562795f0a9077ed1eb047bfb0/h5py-3.13.0.tar.gz
...
%prep
%setup -q -n h5py-3.13.0
cd %{_builddir}/h5py-3.13.0
pushd ..
cp -a h5py-3.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739988386
