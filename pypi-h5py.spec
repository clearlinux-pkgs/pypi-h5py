...
Source0  : https://files.pythonhosted.org/packages/37/fc/0b1825077a1c4c79a13984c59997e4b36702962df0bca420698f77b70b10/h5py-3.10.0.tar.gz
...
%prep
%setup -q -n h5py-3.10.0
cd %{_builddir}/h5py-3.10.0
%patch -P 1 -p1
pushd ..
cp -a h5py-3.10.0 buildavx2
popd
