...
Source0  : https://files.pythonhosted.org/packages/52/8f/e557819155a282da36fb21f8de4730cfd10a964b52b3ae8d20157ac1c668/h5py-3.11.0.tar.gz
...
%prep
%setup -q -n h5py-3.11.0
cd %{_builddir}/h5py-3.11.0
pushd ..
cp -a h5py-3.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725566933
